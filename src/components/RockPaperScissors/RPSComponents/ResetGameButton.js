...
const ResetGameButton = () => {
  ...
  return (
		<button onClick={ () => resetGame() } className="ResetGameButton play-again invisible flex-grow mt-8 py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-center border rounded-md
